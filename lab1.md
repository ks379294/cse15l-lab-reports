...
1. What the working directory was when the command was run: `/home`
2. Why you I got that output: Since I am in the `/home` directory, I got the output of <span style="color:blue">lecture1</span>., since that is the only folder or file in the `/home` directory.
